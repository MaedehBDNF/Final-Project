...
public class SearchPresentationController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        if (this.responseDto != null) {
            ArrayList<MusicEntity> musics = this.responseDto.getMusics();
            if (musics != null) {
            ...
            ArrayList<AlbumEntity> albums = this.responseDto.getAlbums();
            if (albums != null) {
            ...
            ArrayList<PlaylistEntity> playlists = this.responseDto.getPlaylists();
            if (playlists != null) {
            ...
            ArrayList<ArtistEntity> artists = this.responseDto.getArtists();
            if (artists != null) {
            ...
            ArrayList<UserEntity> users = this.responseDto.getUsers();
            if (users != null) {
